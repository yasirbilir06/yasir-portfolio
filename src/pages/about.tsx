    ...
    return (
        <>
            ...
            <Head>
                ...
                <meta
                    property="og:title"
                    content={isEnglish ? "About Me | Yasir Bilir" : "Hakkımda | Yasir Bilir"}
                />
                <meta
            ...
            {/* Sayfa İçeriği */}
            <FadeInSection>
                <div className="bg-gradient-to-b from-cyan-400 via-white to-white py-16 px-6 min-h-screen">
                    ...
                    {/* Profil Kartı */}
                    <div className="max-w-5xl mx-auto bg-white/70 backdrop-blur-md p-10 rounded-3xl shadow-2xl text-gray-800 space-y-10">

                        {/* Kimim Ben */}
                        <div className="space-y-4">
                            <h2 className="text-2xl font-bold text-cyan-700">
                                {isEnglish ? "Who Am I?" : "Kimim Ben?"}
                            </h2>
                            <p>
                                {isEnglish
                        ...
                        <div className="space-y-4">
                            <h2 className="text-2xl font-bold text-cyan-700">
                                {isEnglish ? "My Journey into Software" : "Yazılımla Tanışmam"}
                            </h2>
                            <p>
                                {isEnglish
                        ...
                        <div className="space-y-4">
                            <h2 className="text-2xl font-bold text-cyan-700">
                                {isEnglish ? "Starting with Flutter and Firebase" : "Flutter ve Firebase ile Başlangıç"}
                            </h2>
                            <p>
                                {isEnglish
                        ...
                        <div className="space-y-4">
                            <h2 className="text-2xl font-bold text-cyan-700">
                                {isEnglish ? "Progress with React Native" : "React Native ile Gelişim"}
                            </h2>
                            <p>
                                {isEnglish
                        ...
                        <div className="space-y-4">
                            <h2 className="text-2xl font-bold text-cyan-700">
                                {isEnglish ? "NutriPocket Application" : "NutriPocket Uygulaması"}
                            </h2>
                            <p>
                                {isEnglish
                        ...
                        <div className="space-y-4">
                            <h2 className="text-2xl font-bold text-cyan-700">
                                {isEnglish ? "Education and Work Experience" : "Eğitim ve Çalışma Deneyimi"}
                            </h2>
                            <p>
                                {isEnglish
                        ...
                        <div className="space-y-4">
                            <h2 className="text-2xl font-bold text-cyan-700">
                                {isEnglish ? "Goals and Hobbies" : "Hedeflerim ve Hobilerim"}
                            </h2>
                            <p>
                                {isEnglish
